...
from ibkr_core.core.models import AuditLog, PositionCompliance
...
async def screen_positions(req: ScreenPositionsRequest) -> List[ComplianceStatus]:
    import asyncio
    from ibkr_core.features.compliance.screening import screen_many
...
def clear_screen_cache(symbol: str | None = None):
    from ibkr_core.features.compliance.screening import invalidate_screen_cache
