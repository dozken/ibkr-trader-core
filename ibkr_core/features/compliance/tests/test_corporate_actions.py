...
class TestCorporateActionDetection(unittest.TestCase):
    ...
    def _check(self, news_titles, news_limit=20):
        ...
        with patch("ibkr_core.features.compliance.corporate_actions.yf.Ticker", return_value=mock_ticker):
    ...
    def test_yfinance_exception_returns_empty(self):
        from ibkr_core.features.compliance.corporate_actions import check_corporate_actions
        with patch(
            "ibkr_core.features.compliance.corporate_actions.yf.Ticker",
    ...
    @patch("ibkr_core.features.compliance.corporate_actions.httpx.get")
    def test_fmp_merger_detected(self, mock_get):
        ...
        with patch("ibkr_core.features.compliance.corporate_actions.FMP_API_KEY", "test-key"):
            with patch("ibkr_core.features.compliance.corporate_actions.yf.Ticker") as mock_yf:
...
class TestCorporateActionAlertFields(unittest.TestCase):
    ...
    def test_alert_dataclass_fields(self):
        from ibkr_core.features.compliance.corporate_actions import CorporateActionAlert
