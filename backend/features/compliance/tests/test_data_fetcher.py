...
from backend.features.compliance.data_fetcher import (
    normalize_ticker,
    _is_shariah_etf,
...
class TestFetchFinancialData(unittest.TestCase):
    ...
    def test_fmp_fallback_when_yfinance_ratios_zero(self, MockTicker):
        ...
        with patch("backend.features.compliance.data_fetcher.FMP_API_KEY", "test-key"):
            with patch("backend.features.compliance.data_fetcher._fetch_fmp_fundamentals", 
    ...
    def test_av_fallback_for_us_tickers_when_fmp_missing(self, MockTicker):
        ...
        with patch("backend.features.compliance.data_fetcher.FMP_API_KEY", None):
            with patch("backend.features.compliance.data_fetcher.AV_API_KEY", "test-key"):
                with patch("backend.features.compliance.data_fetcher._fetch_av_fundamentals",
...
class TestFMPProfileFallback(unittest.TestCase):
    ...
    def test_fmp_profile_used_when_yfinance_fails(self, MockTicker):
        from backend.features.compliance.data_fetcher import _fetch_fmp_profile
        ...
        with patch("backend.features.compliance.data_fetcher._fetch_fmp_profile",
    ...
    def test_fmp_profile_not_called_when_yfinance_succeeds(self, MockTicker):
        ...
        with patch("backend.features.compliance.data_fetcher._fetch_fmp_profile") as mock_fmp:
...
class TestFetchFMPProfile(unittest.TestCase):
    ...
    def test_returns_profile_data(self):
        ...
        with patch("backend.features.compliance.data_fetcher.httpx.get",
