...
import backend.features.compliance.screening as screening_mod
from backend.features.compliance.screening import (
    ComplianceStatus,
...
_TARGET = "backend.features.compliance.screening._live_shariah_screen_uncached"
