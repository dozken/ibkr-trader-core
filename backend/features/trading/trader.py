...
from backend.core.state import TradeState, TradeStateMachine
from backend.features.trading.schemas import Trade, TradeCreate
...
from backend.core.models import TradeHistory, AuditLog, TwapExecution
from backend.features.settings.service import load_settings as _load_settings, RISK_STOP_TAKE
from backend.core.monitoring import TRADES_EXECUTED
from backend.features.compliance.vix import get_current_vix, vix_to_tier
    ...
    async def execute_trade(
        ...
        **compliance_data,
        ...
        try:
            ...
            from backend.core.audit import secure_log_entry
