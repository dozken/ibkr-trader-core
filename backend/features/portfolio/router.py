...
from backend.core.market_hours import market_status, EXCHANGE_CONFIG
from backend.core.database import get_db
from backend.core.models import TradeHistory, PortfolioSnapshot, PositionCompliance, PurificationHistory, AuditLog
...
async def manual_rerate(request: Request):
    ...
    from backend.core.models import PendingSignal
