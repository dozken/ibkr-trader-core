const TRADE_STATE_LABELS: Record<string, string> = {
  ...
  REJECTED_CONCENTRATION: 'Blocked — Concentration Limit',
...
const TRADE_STATE_TOOLTIPS: Record<string, string> = {
  ...
  REJECTED_CONCENTRATION: 'Position or sector concentration limit reached — not a cash shortfall. Increase max_position_size_pct/max_sector_exposure_pct or wait for other positions to trim.',
